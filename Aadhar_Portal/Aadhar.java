...
public class Aadhar {
  ...
  private static String password4="KRIS1999";
			...
			case "BHAR2000": {
				...
				case 1: {
					 ...
					 Aadharencapss a=new Aadharencapss("Bharath",9876543202l,90785456789l,"07/09/2000");
						...
						System.out.println("User NUMBER :"+a.getNum());
						System.out.println("User P_NUMBER :"+a.getContact());
	 ...
	 /*   Aadharencapss a=new Aadharencapss("Tabrez",9876543201l,89765432190l);
		System.out.println("\t\"Aadhar Card\"");
		System.out.println("User Name :"+a.getName());
		System.out.println("User NUMBER :"+a.getNum());
		System.out.println("User P_NUMBER :"+a.getContact());
		System.out.println("User DOB :"+a.getDob());
		System.out.println("\tTHANK YOU\3\3\3");
		edit(a.getName(),a.getContact(),a.getNum());*/
	  ...
	  public static void edit(String name,long contact,long Aadharnum,String Dob) {
		...
		public static void editName(String name,long contact,long Aadharnum,String Dob){
		                       ...
		                       System.out.println("User Aadharnumber :"+b.getNum());
		                       System.out.println("User mobilenumber :"+b.getContact());
		                        System.out.println("User dob :"+b.getDob());
		                       System.out.println("\tTHANK YOU\3\3\3");
			...
			public  static void editContact(String name,long contact,long Aadharnum,String Dob){
		                       ...
		                       System.out.println("User Aadharnumber :"+c.getNum());
		                       System.out.println("User mobilenumber :"+c.getContact());
		                        System.out.println("User dob :"+c.getDob());
		                       System.out.println("\tTHANK YOU\3\3\3");
			...
			public static void editDob(String name,long contact,long Aadharnum,String Dob){
					            ...
					            d.setDob(Newdob);
								System.out.println("\t\"Aadhar Card\"");
		                        System.out.println("User Name :"+d.getName());
		                       System.out.println("User Aadharnumber :"+d.getNum());
		                       System.out.println("User mobilenumber :"+d.getContact());
		                        System.out.println("User dob :"+d.getDob());
		                       System.out.println("\tTHANK YOU\3\3\3");
		...
		public static void editNameandDob(String name,long contact,long Aadharnum,String Dob){
		                       ...
		                       System.out.println("User Aadharnumber :"+e.getNum());
		                       System.out.println("User mobilenumber :"+e.getContact());
		                        System.out.println("User dob :"+e.getDob());
		                       System.out.println("\tTHANK YOU\3\3\3");
		...
		public static void editNameandContact(String name,long contact,long Aadharnum,String Dob){
					           ...
					           System.out.println("\t\"Aadhar Card\"");
		                        System.out.println("User Name :"+f.getName());
		                       System.out.println("User Aadharnumber :"+f.getNum());
		                       System.out.println("User mobilenumber :"+f.getContact());
		                        System.out.println("User dob :"+f.getDob());
		                       System.out.println("\tTHANK YOU\3\3\3");
		...
		public static void editDobandContact(String name,long contact,long Aadharnum,String Dob){
	                           ...
	                           System.out.println("\t\"Aadhar Card\"");
		                        System.out.println("User Name :"+g.getName());
		                       System.out.println("User Aadharnumber :"+g.getNum());
		                       System.out.println("User mobilenumber :"+g.getContact());
		                        System.out.println("User dob :"+g.getDob());
		                       System.out.println("\tTHANK YOU\3\3\3");
		...
		public static void editNameandDobandContact(String name,long contact,long Aadharnum,String Dob){
								...
								System.out.println("\t\"Aadhar Card\"");
		                        System.out.println("User Name :"+h.getName());
		                       System.out.println("User Aadharnumber :"+h.getNum());
		                       System.out.println("User mobilenumber :"+h.getContact());
		                        System.out.println("User dob :"+h.getDob());
		                       System.out.println("\tTHANK YOU\3\3\3");
